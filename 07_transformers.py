...
def main():
    ...
    note("Row sums are all 1.0 — each token distributes attention across all positions.")
    ...
    text("""
        ...
        1. **Residual connection**: $x + \\text{sublayer}(x)$ — lets gradients
    ...
    note("The Transformer has no recurrence and no convolution — pure attention and matrix multiplications. That's why it parallelises so efficiently on GPUs and TPUs.")
