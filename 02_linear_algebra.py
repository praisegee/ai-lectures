...
def main():
    ...
    text("""
        The *dimensionality* of a vector is its length, meaning the number of features.
    ...
    text("""
        ...
        is an $N \\times D$ matrix, with one row per example and one column per feature.
    ...
    text("""
        ...
        This captures similarity regardless of magnitude, so a short and a long vector
    ...
    text("""
        ...
        The scalar $\\lambda$ is the eigenvalue, measuring how much that direction is stretched or compressed.
    ...
    text("""
        The largest eigenvalue corresponds to the direction of maximum variance, which is the first principal component.
